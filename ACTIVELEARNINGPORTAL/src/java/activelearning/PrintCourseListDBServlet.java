 ...
 */
@WebServlet("/UserRepo")
public class PrintCourseListDBServlet extends HttpServlet {
...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    try {
        ...
        HeaderFooterPageEvent event = new HeaderFooterPageEvent(loggedInUser,"Active Learning Student Course List");
        writer.setPageEvent(event);
        document.open();

        //PdfPTable table = isAdmin ? createAdminTable(jdbcUrl) : isIns ? createInstructorTable(mysqlUrl) : new PdfPTable(1);
        PdfPTable table = createInstructorTable(mysqlUrl, loggedInUser);
        document.add(table);
        document.close();
        writer.close();
...
private PdfPTable createInstructorTable(String mysqlUrl, String currentUser) throws ClassNotFoundException, SQLException, DocumentException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException, Exception {
    ...
    while (resultSet.next()) {
            ...
            if(currentUser.equals(instructorDB))
            {
...
/*private PdfPTable createAdminTable(String jdbcUrl) throws ClassNotFoundException, SQLException, DocumentException {
    ...
    response.setContentType("application/pdf");
    String filename = "ActiveLearningCourseList" + getCurrentTime() + ".pdf";
