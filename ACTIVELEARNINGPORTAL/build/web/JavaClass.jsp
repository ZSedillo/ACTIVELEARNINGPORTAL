...
<div class="header-container">
    <h1>Welcome to Java Programming Class</h1>
...
<div class="container">
 <div class="container-item" id="overview">
      ...
      <div class="hidden-text">
         <p>This Java Programming course provides extensive experience with the Java language and its object-oriented features. This program will benefit professionals who wish to take the Oracle Certified Java Programmer certification and who want to pursue a career in Java or Android development.</p>
      </div>
   </div>
...
<div class="container-item" id="course-outline">
   ...
   <div class="dropdown">
      ...
      <div class="dropdown-content">
         <p>This is the Java platform section of the course.</p>
      </div>
   </div>
   <div class="dropdown">
      <div class='overview'><label class="label">Java Development Overview </label><button class="dropdown-btn" id="dropdown-btn"> <i class="fas fa-angle-down"></i></button>
          ...
          <div class="dropdown-content">
         <p>This is the Java development overview section of the course.</p>
      </div>
   </div>
   <div class="dropdown">
      <div class='overview'><label class="label">Java Language Fundamentals </label><button class="dropdown-btn" id="dropdown-btn"><i class="fas fa-angle-down"></i></button>
          ...
          <div class="dropdown-content">
         <p>This is the Java Language Fundamentals section of the course.</p>
      </div>
   </div>
</div>
   ...
   <div class="container-item" id="schedule">
    ...
    if ("Self-Paced".equals(typeOfClass)) {
%>
