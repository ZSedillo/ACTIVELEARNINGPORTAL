...
<div class="container">
 <div class="container-item" id="overview">
    <div class='overview'><h2>Overview </h2><button class="dropdown-btn" id="dropdown-btn"><i class="fas fa-angle-down"></i></button></div>      <div class="hidden-text">
...
<div class="container-item" id="course-outline">
   ...
   <div class="dropdown">
      <div class='overview'><label class="label">Introduction to HTML </label><button class="dropdown-btn"> <i class="fas fa-angle-down"></i></button>
      </div>
          <div class="dropdown-content">
         <p>This is the introduction to HTML section of the course.</p>
      </div>
   </div>
   <div class="dropdown">
      <div class='overview'><label class="label">Formatting Text </label><button class="dropdown-btn"> <i class="fas fa-angle-down"></i></button>
      </div>
          <div class="dropdown-content">
         <p>This is the formatting text section of the course.</p>
      </div>
   </div>
   <div class="dropdown">
      <div class='overview'><label class="label">Formatting with CSS </label><button class="dropdown-btn"><i class="fas fa-angle-down"></i></button>
      </div>
          <div class="dropdown-content">
         <p>This is the formatting with CSS section of the course.</p>
      </div>
   </div>
</div>
